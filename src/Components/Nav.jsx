...
import { UserOutlined, DashboardOutlined, AppstoreOutlined, ShopOutlined, SearchOutlined, HomeFilled, AppstoreFilled } from '@ant-design/icons';
    ...
    return (
        <Header style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #E5E8EB', position: 'fixed', zIndex: 1, width: '100%', top: 0, left: 0 }}>
            <Flex justify='space-between' align='center' gap='large'>
                <div style={{ fontSize: 18, fontWeight: 700, fontFamily: 'Work Sans' }}>cardfolio</div>
                <Search size='large'/>
                <Space size='large'>
                    <Menu mode="horizontal" defaultSelectedKeys={['1']} style={{ borderBottom: 'none', width: '20vw', display: 'flex', justifyContent: 'center' }}>
                        ...
                        <Menu.Item key="2" icon={<AppstoreFilled />}>Sets</Menu.Item>
                    </Menu>
